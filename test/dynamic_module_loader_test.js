...
describe('DynamicModuleLoaderTest', function ()
{
  ...
  function runTest(expectDownloadRequest, expectedDownloadTarget, targetModulePackagePath, explicitLoadMethodExtension,
                   shouldRegisterListeners, expectedErrorMessage, expectModuleInstallationDirRename, done, downloadPath, addModuleInCallback)
  {
    ...
    if (shouldRegisterListeners)
    {
      ...
      dynamicModuleLoader.on(dynamicModuleLoader.events.moduleInstalled, function (moduleName, installationLocation,
                                                                                   proceed)
      {
